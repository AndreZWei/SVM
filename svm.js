...
var _user$project$Main$string = F2(
	function (n, total) {
		...
		if (_p0 === true) {
			return _elm_lang$core$Basics$toString(total - n);
		} else {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(total - n),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'\n',
...
var _user$project$Main$model = {
	...
	psw: 0,
	image: {
		text: _elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$ramPut = F3(
	function (v, n, segment) {
		...
		if (_p1 === 0) {
			...
			return A2(
				_elm_lang$core$List$append,
				A2(_elm_lang$core$List$take, n - 1, segment),
				A2(
					_elm_lang$core$List_ops['::'],
					v,
		...
		switch (_p5.ctor) {
			...
			case 'R3':
				return _elm_lang$core$Native_Utils.update(
					...
					{r3: value});
			default:
				return A2(_elm_lang$core$Debug$log, 'Can\'t write in Zero Register', r);
		}
	});
...
var _user$project$Main$string_of_regs = function (r) {
	var r3s = _elm_lang$core$Basics$toString(r.r3);
	var r2s = _elm_lang$core$Basics$toString(r.r2);
	var r1s = _elm_lang$core$Basics$toString(r.r1);
	var r0s = _elm_lang$core$Basics$toString(r.r0);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'{r0=',
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'; r3=',
								A2(_elm_lang$core$Basics_ops['++'], r3s, '}'))))))));
};
var _user$project$Main$printState = F4(
	function (pc, psw, ra, registers) {
		var regstr = _user$project$Main$string_of_regs(registers);
		var si = _elm_lang$core$Basics$toString;
		return A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										')\n',
										A2(_elm_lang$core$Basics_ops['++'], 'dbg: regs =', regstr)))))))),
			{ctor: '_Tuple0'});
	});
var _user$project$Main$cycle = function (model) {
				...
				if ((((_p10.ctor === '_Tuple3') && (_p10._0.ctor === 'Just')) && (_p10._1.ctor === 'Just')) && (_p10._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Lod command in line ',
				...
				if (((_p11.ctor === '_Tuple2') && (_p11._0.ctor === 'Just')) && (_p11._1.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Li command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Sto':
				...
				if ((((_p12.ctor === '_Tuple3') && (_p12._0.ctor === 'Just')) && (_p12._1.ctor === 'Just')) && (_p12._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Sto command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Mov':
				...
				if (((_p14.ctor === '_Tuple2') && (_p14._0.ctor === 'Just')) && (_p14._1.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Mov command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Add':
				...
				if ((((_p15.ctor === '_Tuple3') && (_p15._0.ctor === 'Just')) && (_p15._1.ctor === 'Just')) && (_p15._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Add command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Sub':
				...
				if ((((_p16.ctor === '_Tuple3') && (_p16._0.ctor === 'Just')) && (_p16._1.ctor === 'Just')) && (_p16._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Sub command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Mul':
				...
				if ((((_p17.ctor === '_Tuple3') && (_p17._0.ctor === 'Just')) && (_p17._1.ctor === 'Just')) && (_p17._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Mul command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Div':
				...
				if ((((_p18.ctor === '_Tuple3') && (_p18._0.ctor === 'Just')) && (_p18._1.ctor === 'Just')) && (_p18._2.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Div command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Cmp':
				...
				if (((_p19.ctor === '_Tuple2') && (_p19._0.ctor === 'Just')) && (_p19._1.ctor === 'Just')) {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Cmp command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Blt':
				...
				if (_p20.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Blt command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Beq':
				...
				if (_p22.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Beq command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Bgt':
				...
				if (_p24.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Bgt command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Jmp':
				...
				if (_p26.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Jmp command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'Jsr':
				...
				if (_p27.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							errorMsg: A2(
								_elm_lang$core$Basics_ops['++'],
								'There is something wrong with your Jsr command in line ',
								_elm_lang$core$Basics$toString(pc))
						});
				}
			case 'R':
			...
			default:
				var _p28 = {
					...
					_0: A2(
						...
						'\nSVM Halt',
						{ctor: '_Tuple0'}),
					_1: A4(_user$project$Main$printState, pc, psw, ra, registers)
				};
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$reg_of_string = function (s) {
	...
	switch (_p29) {
		...
		case 'R1':
			return _elm_lang$core$Maybe$Just(_user$project$Main$R1);
		case 'R2':
			return _elm_lang$core$Maybe$Just(_user$project$Main$R2);
		case 'R3':
			return _elm_lang$core$Maybe$Just(_user$project$Main$R3);
		case 'ZERO':
			return _elm_lang$core$Maybe$Just(_user$project$Main$Zero);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Main$Hlt = {ctor: 'Hlt'};
var _user$project$Main$Jmp = function (a) {
	return {ctor: 'Jmp', _0: a};
};
var _user$project$Main$Bgt = function (a) {
	return {ctor: 'Bgt', _0: a};
};
var _user$project$Main$Beq = function (a) {
	return {ctor: 'Beq', _0: a};
};
var _user$project$Main$Blt = function (a) {
	return {ctor: 'Blt', _0: a};
};
var _user$project$Main$R = {ctor: 'R'};
var _user$project$Main$Jsr = function (a) {
	return {ctor: 'Jsr', _0: a};
};
var _user$project$Main$Cmp = function (a) {
	return {ctor: 'Cmp', _0: a};
};
var _user$project$Main$Div = function (a) {
	return {ctor: 'Div', _0: a};
};
var _user$project$Main$Mul = function (a) {
	return {ctor: 'Mul', _0: a};
};
var _user$project$Main$Sub = function (a) {
	return {ctor: 'Sub', _0: a};
};
var _user$project$Main$Add = function (a) {
	return {ctor: 'Add', _0: a};
};
var _user$project$Main$Mov = function (a) {
	return {ctor: 'Mov', _0: a};
};
var _user$project$Main$Sto = function (a) {
	return {ctor: 'Sto', _0: a};
};
var _user$project$Main$Li = function (a) {
	return {ctor: 'Li', _0: a};
};
var _user$project$Main$Lod = function (a) {
